...
export default function loginAdmin() {
    ...
    return (
        <>
            ...
            <div className='' style={{ height: "100vh", backgroundImage: "url('https://res.cloudinary.com/dwk3twqte/image/upload/v1778591351/sambeetarts-geometric-1732847_jszoq0.jpg')" }}>
